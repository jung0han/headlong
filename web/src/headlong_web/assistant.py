...
class PersonalAssistant:
    ...
    def _analyze_revision(
        ...
        system = (
            ...
            "Return at most three memory candidates, three improvement signals, and "
            "three archive candidates. Cite no more than two Evidence Locators per "
            "conclusion and prefer one. Keep the observation and every candidate "
            "content or rationale to one concise sentence. "
