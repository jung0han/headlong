...
export default [
  ...
  route("i/:identityId/proposals", "routes/proposals.tsx"),
  route("i/:identityId/archive-candidates", "routes/archive-candidates.tsx"),
  route("i/:identityId/shadow", "routes/shadow.tsx"),
