...
TOOLS=(shellm shellm-docker skills mem llm context traj thinkers chat focus recap glob view put sub
       shellm-docker-broker identity shellm-explore headlong-init headlong-model-probe headlong-json-schema headlong-model-result headlong-recap-render headlong-run-summary headlong-killall persona headlong-web headlong-assistant
